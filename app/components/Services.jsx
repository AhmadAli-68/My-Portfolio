			...
			<motion.div
				...
				{serviceData.map(({ icon, title, description, link }, index) => (
					<motion.div
						...
						key={index}
						className='border-[0.5px] border-darkBorder rounded-lg px-8 py-12 hover:shadow-black hover:shadow-secondary transition-all duration-500 ease-in-out cursor-pointer hover:-translate-y-1 hover:bg-darkHover'
					>
